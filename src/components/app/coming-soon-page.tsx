...
export function ComingSoonPage({ activeNavLabel, description, icon, title }: ComingSoonPageProps) {
  return (
    ...
    >
      ...
      <section className="rounded-lg border border-[#c6c6cd]/70 bg-white p-8 shadow-[0_4px_20px_rgba(15,23,42,0.04)]">
        <div className="mx-auto flex max-w-2xl flex-col items-center text-center">
          <span className="grid size-14 place-items-center rounded-lg bg-[#eff6ff] text-[#0058be]">
            <Icon className="size-7" name={icon} />
          </span>
          <p className="mt-5 text-xs font-bold uppercase text-[#45464d]">Coming Soon</p>
          <h2 className="mt-2 text-2xl font-semibold text-[#0b1c30]">{title} is not developed yet</h2>
