...
import { getAccountAmountTypeCatalog } from "@/lib/accounts/amount-type-catalog";
...
export default async function AddAccountPage({
  ...
  const [categories, amountTypeCatalog] = await Promise.all([
    getCategories(),
    user ? getAccountAmountTypeCatalog(supabase, user.id) : Promise.resolve(["Operation"]),
  ]);
  ...
  return (
    ...
    >
      ...
      <AddAccountForm amountTypeCatalog={amountTypeCatalog} categories={categories} returnTo={returnTo} />
    </AppShell>
  );
}
