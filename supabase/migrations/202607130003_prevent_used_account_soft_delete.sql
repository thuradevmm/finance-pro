-- Financial accounts with history must be archived, not soft-deleted.
-- Removing a referenced account hides its ledger contribution from account
-- totals while the economic transaction remains, causing reconciliation drift.
